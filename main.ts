//% color="#C814B8" weight=25 icon="\uf1d4" block="StemBit Display"
namespace stembit_Display {
    ...
    //% blockId=stembit_LED1 block="LED1|pin %pin|value %value"
    //% weight=5
    //% blockGap=8
    //% color="#C814B8"
    ...
    //% blockId=stembit_LED2 block="LED2|pin %pin|value %value"
    //% weight=4
    //% blockGap=8
    //% color="#C814B8"
    ...
    //% blockId=stembit_BreathLED block="BreathLED|pin %pin"
    //% weight=3
    //% blockGap=8
    //% color="#C814B8"
    ...
    //% blockId=stembit_RGB block="RGB|pin1 %pin1|pin2 %pin2|pin3 %pin3|value1 %value1|value2 %value2|value3 %value3"
    //% weight=2
    //% blockGap=8
    //% color="#C814B8"
    ...
    //% blockId=stembit_RGB2 block="RGB|pin1 %pin1|pin2 %pin2|pin3 %pin3|value %value"
    //% weight=1
    //% blockGap=8
    //% color="#C814B8"
...
//% color="#87CEEB" weight=24 icon="\uf1b6" block="StemBit Sensor"
namespace stembit_Sensor {
    ...
    //% blockId=stembit_Voice_Sensor block="Voice_Sensor|pin %pin|value %value"
    //% weight=100
    //% blockGap=10
    //% color="#87CEEB"
    ...
    //% blockId=stembit_IR_Sensor block="IR_Sensor|pin %pin| |%value|obstacle"
    //% weight=100
    //% blockGap=10
    //% color="#87CEEB"
...
if (pins.digitalReadPin(pin) == value) {
    ...
    //% blockId=stembit_IR_Send block="IR_Send|pin %pin"
    //% weight=100
    //% blockGap=10
    //% color="#87CEEB"
...
//% color="#808080" weight=23 icon="\uf11c" block="StemBit Input"
namespace stembit_Input {
    ...
    //% blockId=stembit_TouchPad block="TouchPad|pin %pin|value %value"
    //% weight=100
    //% blockGap=10
    //% color="#808080"
    ...
    //% blockId=stembit_Rocker block="Rocker|VRX %pin1|VRY %pin2|SW %pin3|value %value"
    //% weight=100
    //% blockGap=10
    //% color="#808080"
    ...
    //% blockId=stembit_Button block="Button|pin %pin|value %value"
    //% weight=100
    //% blockGap=10
    //% color="#808080"
...
//% color="#D2691E" weight=22 icon="\uf001" block="StemBit Music"
namespace stembit_Music {
    ...
    //% blockId=stembit_Buzzer block="Buzzer|pin %pin|value %value"
    //% weight=100
    //% blockGap=10
    //% color="#D2691E"
...
//% color="#0000CD" weight=21 icon="\uf185" block="StemBit Motor"
namespace stembit_Motor {

    //% blockId=stembit_Fan block="Fan|pin %pin|speed %value"
    //% weight=100
    //% blockGap=10
    //% color="#0000CD"
    ...
    //% blockId=stembit_Servo block="Servo|pin %pin|value %value"
    //% weight=100
    //% blockGap=10
    //% color="#0000CD"
...
//% color="#006400" weight=20 icon="\uf1b9" block="StemBit Robot"
namespace stembit_Robot {
    ...
    export enum enAvoidState {
        //% block="with obstacles"
        OBSTACLE = 0,
        //% block="without obstacles"
        NOOBSTACLE = 1
     ...
     * @param index
     */
    //% blockId=stembit_RGB_Car_Big2 block="RGB_Car_Big2|value %value"
    //% weight=101
    //% blockGap=10
    //% color="#C814B8"
    ...
    //% blockId=stembit_RGB_Car_Big block="RGB_Car_Big|value1 %value1|value2 %value2|value3 %value3"
    //% weight=100
    //% blockGap=10
    //% color="#C814B8"
    //% value1.min=0 value1.max=255 value2.min=0 value2.max=255 value3.min=0 value3.max=255
	...
	//% blockId=stembit_ultrasonic_car block="ultrasonic return distance(cm)"
    //% color="#006400"
    //% weight=98
    //% blockGap=10
    ...
    //% blockId=stembit_Music_Car block="Music_Car|%index"
    //% weight=97
    //% blockGap=10
    //% color="#006400"
    ...
    //% blockId=stembit_Servo_Car block="Servo_Car|num %num|value %value"
    //% weight=96
    //% blockGap=10
    //% color="#006400"
    ...
    //% blockId=stembit_Avoid_Sensor block="Avoid_Sensor|value %value"
    //% weight=95
    //% blockGap=10
    //% color="#006400"
    ...
    //% blockId=stembit_Line_Sensor block="Line_Sensor|direct %direct|value %value"
    //% weight=94
    //% blockGap=10
    //% color="#006400"
    ...
    //% blockId=stembit_CarCtrl block="CarCtrl|%index"
    //% weight=93
    //% blockGap=10
    //% color="#006400"
    ...
    //% blockId=stembit_CarCtrlSpeed block="CarCtrlSpeed|%index|speed %speed"
    //% weight=92
    //% blockGap=10
    ...
    //% blockId=stembit_CarCtrlSpeed2 block="CarCtrlSpeed2|%index|speed1 %speed1|speed2 %speed2"
    //% weight=91
    //% blockGap=10
